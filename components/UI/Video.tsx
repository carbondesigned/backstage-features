...
const Video = (props: Props) => {
  return (
    <>
      {props.videoId && (
        <div className="rounded-xl overflow-hidden relative p-4 border-[2px] post bg-base-200 border-opacity-30 hover:border-opacity-0 border-neutral-content post-border">
